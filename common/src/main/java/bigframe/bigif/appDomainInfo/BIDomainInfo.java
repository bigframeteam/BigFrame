...
public class BIDomainInfo extends DomainInfo {
	...
	public BIDomainInfo() {
		...
		relational_supportedEngine.add(Constants.HANA);
		...
		graph_supportedEngine.add(Constants.HANA);
		...
		nested_supportedEngine.add(Constants.HANA);
		...
		text_supportedEngine.add(Constants.HANA);		
