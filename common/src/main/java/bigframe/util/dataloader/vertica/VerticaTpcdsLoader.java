...
//					System.out.println("The value: " + fields[i]);
	...
	public void prepareBaseTable() throws SQLException {
		...
		for(String str : drop_table) {
			...
			String createCustomer = "CREATE TABLE customer (c_customer_sk int primary key, c_customer_id char(16),"+
	    	...
	    	String createItem = "Create TABLE item (i_item_sk int primary key, i_item_id char(16), i_rec_start_date date, i_rec_end_date date," +
	    	...
	    	String createPromotion = "CREATE TABLE promotion (p_promo_sk int primary key, p_promo_id char(16), p_start_date_sk int," +
	    	...
	    	String createdateDim = "Create TABLE date_dim (d_date_sk int primary key , d_date_id char(16), d_date date, d_month_seq int, d_week_seq int," +
