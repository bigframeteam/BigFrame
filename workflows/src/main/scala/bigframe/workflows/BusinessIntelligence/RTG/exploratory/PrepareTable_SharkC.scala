...
class PrepareTable_SharkC(basePath: BaseTablePath) {
	 ...
	 * Normal Text File
	 */
	def prepareTableImplText(sc: SharkContext): Unit = {
		...
		sc.runSql(dropItem)
		sc.runSql(dropPromot)
		sc.runSql(dropCust)
		sc.runSql(dropDateDim)
		sc.runSql(dropGraph)
		...
		sc.runSql(createTweets)
		sc.runSql(createWebSales)
		sc.runSql(createCatalogSales)
		sc.runSql(createStoreSales)
		sc.runSql(createItem)
		sc.runSql(createCust)
		sc.runSql(createPromot)
	...
	def prepareTableImplRC(sc: SharkContext): Unit = {
		...
		sc.runSql(dropWebSalesTmp)
		sc.runSql(dropCatalogSalesTmp)
		sc.runSql(dropStoreSalesTmp)
		sc.runSql(dropItemTmp)
		sc.runSql(dropPromotTmp)
		sc.runSql(dropCustTmp)
		sc.runSql(dropDateDimTmp)
		sc.runSql(dropGraphTmp)
		sc.runSql(dropTweetsTmp)
		...
		sc.runSql(createWebSalesTmp)
		sc.runSql(createCatalogSalesTmp)
		sc.runSql(createStoreSalesTmp)
		sc.runSql(createItemTmp)
		sc.runSql(createCustTmp)
		sc.runSql(createPromotTmp)
		sc.runSql(createDateDimTmp)
		sc.runSql(createGraphTmp)
		sc.runSql(createTweetsTmp)
